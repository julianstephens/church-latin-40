...
import { logError, logInfo, logSuccess, logVerbose } from "./utils";
 ...
 */
function printSummary(results: SeedResult[], options: SeedOptions): void {
  console.log("");
  console.log("╔════════════════════════════════════════════════════════╗");
  ...
  console.log(
    `  ⏱️  Total Time:    ${(summary.totalDuration / 1000).toFixed(2)}s`,
  );
