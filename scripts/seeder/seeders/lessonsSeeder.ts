        ...
        try {
            ...
            for (const lessonData of lessons) {
                ...
                try {
                    ...
                    const lessonNumber = lessonNumberMatch ? parseInt(lessonNumberMatch[0], 10) : lessonData.day;
                    ...
                    if (exists) {
                        ...
                        updated++;
                        if (options.dryRun) {
                            logVerbose(`[DRY RUN] Would update lesson ${lessonData.id}`, options);
                        } else {
                        ...
                        added++;
                        if (options.dryRun) {
                            logVerbose(`[DRY RUN] Would create lesson ${lessonData.id}`, options);
                        } else {
