    ...
    useEffect(() => {
        const loadReviewItems = async () => {
            try {
                ...
                const enrichedUpcoming = await enrichItemsWithLessonData(
                    upcomingList,
                );
                const enrichedSuspended = await enrichItemsWithLessonData(
                    suspendedList,
                );
            ...
            <div className="max-w-4xl mx-auto px-4">
                ...
                <div className="flex gap-4 mb-6 border-b border-gray-200 dark:border-gray-700">
                    <button
                        ...
                        className={`px-4 py-3 font-medium transition-colors border-b-2 -mb-1 ${activeTab === "due"
                    ...
                    <button
                        ...
                        className={`px-4 py-3 font-medium transition-colors border-b-2 -mb-1 ${activeTab === "upcoming"
                                ? "border-blue-500 text-blue-600 dark:text-blue-400"
                                : "border-transparent text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200"
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`px-4 py-3 font-medium transition-colors border-b-2 -mb-1 ${activeTab === "suspended"
                                ? "border-blue-500 text-blue-600 dark:text-blue-400"
                                : "border-transparent text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200"
                            }`}
                    >
